...
NO_DESTRUCTION              =      -4                 
NO_KILL                     =      -2             
PLACING_BOMBS_WITH_NO_AMMO  =      -500
BOMB_IN_RANGE               =      -5
...
GUIDANCE                    =       0.9                         # 1 means the agent copies exactly as the coach. 0 means that the agent makes random moves Should be between 1 and 0
